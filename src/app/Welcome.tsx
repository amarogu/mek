...
export default function Welcome() {
    ...
    return (
        <animated.div style={styles} className="fixed z-50 flex justify-center items-center top-0 left-0 w-full h-screen dark:bg-dark-bg-100/75 backdrop-blur-lg border-b border-bg-300/50 dark:border-dark-bg-300/50 bg-bg-100/75">
