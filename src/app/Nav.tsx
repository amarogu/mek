...
export default function Nav() {
    ...
    return (
        <nav className="grid container grid-cols-3 mx-auto items-center justify-items-center">
            ...
            <Image src={isDarkMode ? LogoDark : Logo} className="col-start-1 static z-40 md:col-start-2" alt="Maria & Kalil, com amor," />
            ...
            <button className="cursor-pointer static z-40 col-start-3 md:hidden flex items-center justify-end justify-self-end w-[24px] h-[14px] " onClick={() => setOpen(!open)}>
