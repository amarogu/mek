...
export default function About() {
    ...
    return (
        <section id='about' className='flex flex-col container mx-auto md:flex-row justify-between gap-8 py-24 px-8'>
            ...
            <div className='lg:w-1/2'>
                <div className='flex flex-col gap-6'>
                    ...
                    <p className='text-3xl about-me-container'>
                        {Array.from('Pensa em um amor que tinha que acontecer, em um equilíbrio que dá certo demais, agora pensa também em uma relação que faz sentido, é leve, verdadeira e intensa. Essa é a carinha do nosso casamento').map((char, index) => (
